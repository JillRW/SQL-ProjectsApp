...
public class ProjectsApp {
	...
	private void updateProjectDetails() {
		...
		String projectName =
			...
			project.setEstimatedHours(Objects.isNull(estimated_hours) ? curProject.getEstimatedHours() : estimated_hours);
			project.setActualHours(Objects.isNull(actual_hours) ? curProject.getActualHours() : actual_hours);
	...
	private void selectProject() {
		...
		if(Objects.isNull(curProject)) {
			System.out.println("This is not a valid project");
		}
	}
